 ...
 */
public class ClientCommandLoopImpl implements ClientCommandLoop {
  @InjectLogger
  Logger logger;
  private static final String PROMPT = "> ";
  private Map<String, FileRepositoryClientCommand> aliasMap = new HashMap<String, FileRepositoryClientCommand>();
  private UserOperations commsClient;

  @Inject
  public ClientCommandLoopImpl(UserOperations commsClient) {
